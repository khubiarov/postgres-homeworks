...
SELECT order_id FROM orders WHERE ship_country = 'France' OR ship_country = 'Germany' OR ship_country ='Spain';
...
SELECT min(unit_price), max(unit_price) FROM products WHERE units_in_stock > 19 AND discontinued <> 1;